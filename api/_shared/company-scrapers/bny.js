// BNY (Bank of New York Mellon) runs Oracle Recruiting Cloud, same as
// JPMorgan. The candidate UI reads this unauthenticated JSON feed directly.
// Global bank, so keep only confirmed-US roles.

const { usOnly } = require("../us-location");

const API_URL = "https://eofe.fa.us2.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions";
const JOB_URL = "https://eofe.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/BNY-Careers/job";
const SITE_NUMBER = "BNY-Careers";
const PAGE_SIZE = 100;
...
async function fetchPage(term, offset) {
  ...
  if (!res.ok) throw new Error(`${res.status} bny`);
