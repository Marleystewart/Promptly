// Lazard runs Oracle Recruiting Cloud (student site). Global advisory firm, so
// keep only confirmed-US roles.

const { usOnly } = require("../us-location");

const API_URL = "https://icbpjb.fa.ocs.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions";
const JOB_URL = "https://icbpjb.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/LazardStudentCareers/job";
const SITE_NUMBER = "LazardStudentCareers";
const PAGE_SIZE = 100;
...
async function fetchPage(term, offset) {
  ...
  if (!res.ok) throw new Error(`${res.status} lazard`);
