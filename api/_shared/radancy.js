...
//
// The location text is reliably structured ("City, State, Country" or
// "City, Country"), so this applies the same positive US-location filter as
// the Workday pharma scrapers (see us-location.js) rather than leaning on
// aggregator.js's blocklist alone — that blocklist is necessarily incomplete
// (found via a real leak: Sanofi's Radancy feed listed "Scoppito, Italy",
// which isn't in the blocklist and was slipping through as a US role).
